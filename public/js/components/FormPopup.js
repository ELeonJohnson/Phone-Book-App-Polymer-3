...
<section className="form-popup ${(this.popupOpen) ? 'active' : ''}">
  ...
  <div class="closing-btn" on-click="${this.togglePopup}">
    ...
    <div class="form-group phone_number">
      ...
      <input type="text" name="phone_number" on-keyup="${this.change}"></input>
    </div>

    <div class="form-group category">
      <label for="category">Category</label>
      <input type="text" name="category" on-keyup="${this.change}"></input>
    </div>

    <div class="form-group favorites">
      <label for="favorites">Favorites</label>
      <input type="text" name="favorites" on-keyup="${this.change}"></input>
    </div>
